...
public class FormatageCoordonnesTest {
    ...
    public void verifierAffichageComposantsDetailFragment() {
        ...
        // 3. Lancer le Fragment de manière isolée dans un conteneur avec un bloc try-with-resources
        ...
        } // <- Ici, le scénario se ferme automatiquement et libère les ressources
    }
}